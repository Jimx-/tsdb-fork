...
// TODO(Alec), should come up with some other ways of recording chunk ids when introducing UPDATE and Random Delete.
class MemSeries{
    public: 
        ...
        MemSeries(const label::Labels & labels, uint64_t id, int64_t chunk_range);
