...
public:
    ...
    // std::vector<uint8_t> & rec); static void group_series(const
    // RefGroupSeries & rgs, std::vector<uint8_t> & rec);
    ...
    // std::vector<uint8_t> & rec); static void group_samples(const
    // RefGroupSample & rgs, std::vector<uint8_t> & rec);
