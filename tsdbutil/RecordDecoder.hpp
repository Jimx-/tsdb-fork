...
public:
    ...
    // std::deque<RefGroupSeries> & rgs); static error::Error group_series(const
    // uint8_t* rec, int length, std::deque<RefGroupSeries> & rgs);
    ...
    // std::deque<RefGroupSample> & rgs); static error::Error
    // group_samples(const uint8_t* rec, int length, std::deque<RefGroupSample>
    // & rgs);
    ...
    // std::deque<Stone> & stones); static error::Error group_tombstones(const
    // uint8_t* rec, int length, std::deque<Stone> & stones);
};
