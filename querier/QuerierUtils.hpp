...
class ChunkSeriesSets{
    ...
    public:
        ...
        ChunkSeriesSets(const std::deque<std::shared_ptr<ChunkSeriesSetInterface> > & css);
...
//         GroupChunkSeriesSets(const std::deque<std::shared_ptr<GroupChunkSeriesSetInterface> > & css);
