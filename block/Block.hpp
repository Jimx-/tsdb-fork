...
public:
    ...
    const tombstone::Intervals& get(tagtree::TSID tsid) const;
    ...
    void add_interval(tagtree::TSID tsid, const tombstone::Interval& itvl);
...
public:
    ...
    error::Error del(int64_t mint, int64_t maxt, tagtree::TSID tsid);
