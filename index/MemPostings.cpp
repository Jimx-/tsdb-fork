...
// Used under lock.
void MemPostings::add(const common::TSID& tsid) { m.insert(tsid); }

void MemPostings::del(const std::unordered_set<common::TSID>& deleted)
{
...
void MemPostings::iter(const std::function<void(const common::TSID&)>& f)
{
