...
class IndexReader: public block::IndexReaderInterface{
    private:
        ...
        std::unordered_map<std::string, std::unordered_map<std::string, uint64_t> > postings_table; 
    ...
    public:
        ...
        std::pair<std::unique_ptr<PostingsInterface>, bool> postings(const std::string & name, const std::string & value);
